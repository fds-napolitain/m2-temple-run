...
Player::Player(std::string name) : Entity(std::move(name)) {
	...
	Transform* playerBaseAnimation = new Transform(QQuaternion::fromAxisAndAngle(-1.0, 0.0, 0.0, 90), QVector3D(0.0, 0.0, 0.0), 1.0);
	Transform* playerMidAnimation = new Transform(QQuaternion::fromAxisAndAngle(1.0, 0.0, 0.0, 90), QVector3D(0.0, 0.0, 0.0), 1.0);
	Transform* playerTopAnimation = new Transform(QQuaternion::fromAxisAndAngle(-1.0, 0.0, 0.0, 45), QVector3D(0.0, 0.0, 0.0), 1.0);
